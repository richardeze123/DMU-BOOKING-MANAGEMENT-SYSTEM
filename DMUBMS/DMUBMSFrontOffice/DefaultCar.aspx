...
<body>
    ...
    CssClass="auto-style25" Text="Car Management " Font-Bold="True" 
            ...
            <asp:Label ID="lblManageCars" runat="server" CssClass="auto-style13" Font-Bold="True" Font-Names="Berlin Sans FB Demi" Font-Size="X-Large" ForeColor="White" Text="Manage Cars"></asp:Label>
            ...
            <asp:TextBox ID="txtRegNo" runat="server" CssClass="auto-style39" OnTextChanged="txtRegNo_TextChanged"></asp:TextBox>
        </asp:Panel>
