...
<body>
    ...
    CssClass="auto-style12" Text="DMU BOOKING MANAGEMENT SYSTEM" Font-Bold="True" 
            ...
            <asp:Label ID="Label7" runat="server" CssClass="auto-style14" Font-Bold="True" Font-Size="X-Large" ForeColor="OrangeRed" Text="Current Password"></asp:Label>
            ...
            <asp:Button ID="Button3" runat="server" CssClass="auto-style26" Font-Size="Large" ForeColor="#666666" Text="Change Password" />
            <asp:Button ID="Button7" runat="server" CssClass="auto-style29" Font-Size="Large" ForeColor="#666666" Text="Done" />
        </asp:Panel>
