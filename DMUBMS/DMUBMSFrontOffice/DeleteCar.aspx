...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="Red" ForeColor="#33CC33" style="z-index: 1; left: 8px; top: 29px; position: absolute; height: 144px; width: 843px">
            ...
            <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="XX-Large" ForeColor="White" style="z-index: 1; left: 317px; top: 91px; position: absolute; width: 200px; margin-bottom: 7px" Text="Manage Cars"></asp:Label>
        </asp:Panel>
        ...
        <p>
            &nbsp;</p>
        <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="Larger" style="z-index: 1; left: 208px; top: 226px; position: absolute; width: 584px" Text="Are you sureb you want to Delete this Car?"></asp:Label>
