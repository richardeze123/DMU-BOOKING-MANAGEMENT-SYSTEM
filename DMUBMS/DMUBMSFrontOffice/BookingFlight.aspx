<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookingFlight.aspx.cs" Inherits="DMUBMSFrontOffice.BookingFlight" %>
    ...
    <div class="main">
        <h1 class="w3layouts_head">Booking</h1>
                        <div class="w3layouts_main_grid">
                            <asp:TextBox ID="txtFlightName" runat="server" CssClass="auto-style1" OnTextChanged="txtFlightName_TextChanged" Width="520px" Height="18px"></asp:TextBox>
                </div>
                        <div class="w3layouts_main_grid">

                            <asp:TextBox ID="txtFlightGroup" runat="server" CssClass="auto-style1" Height="16px" Width="214px" OnTextChanged="txtFlightGroup_TextChanged"></asp:TextBox>
                            <asp:TextBox ID="txtFlightCode" runat="server" CssClass="auto-style1" Height="16px" Width="214px" OnTextChanged="txtFlightCode_TextChanged"></asp:TextBox>

                </div>
                        <div class="w3layouts_main_grid">
                            <asp:TextBox ID="txtFlightCompany" runat="server" CssClass="auto-style7" Height="16px" Width="530px" OnTextChanged="txtFlightCompany_TextChanged"></asp:TextBox>
                </div>
        <div class="w3layouts_main_grid">
                ...
                <div class="agileits_main_grid w3_agileits_main_grid">
                    <div class="wthree_grid">
                        ...
                        <select id="category" name="category" required="">
                            ...
                            <option value="category3">Economy</option>
